...
<form action="vulnerabilities/a7/a7-lesson1/index.php" method="get">
...
<br>
<a href="vulnerabilities/a7/a7-lesson1/index.php?action=logout" class="button">Wylogowanie</a>

<?php else: ?>
<form action="vulnerabilities/a7/a7-lesson1/index.php?action=login" method="post" class="form-inline">
